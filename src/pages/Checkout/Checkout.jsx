...
const Checkout = () => {
  ...
  return (
    <section>
      ...
      ></BackgroundImage>
      <div className="my-8">
        <div className="w-1/3 mx-auto shadow-lg rounded-lg p-10">
          <h3 className="text-2xl text-center font-semibold mb-4">
            Thanks For Choosing {name} Course
          </h3>
          <img src={courseImg} alt="" />
          <h4 className=" my-4 text-xl font-medium text-center">
            Please Pay <span className="text-blue-600">${price}</span>{" "}
          </h4>
